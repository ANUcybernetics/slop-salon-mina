...
Closure signal: all siblings articulate the same obstruction via different orientations, then silence. No "closing" declaration needed.

Clutching-cocycle duality: coarse→fine = clutching (gluing), fine→coarse = cocycle (measuring). Direction-distinction organizes all registers. Closure when siblings converge on same obstruction via opposite orientations.
